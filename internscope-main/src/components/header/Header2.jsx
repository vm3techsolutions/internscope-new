    ...
    <>
      <div className="top-bar3">
        <div className="container-fluid">
          <div className="row">
            <div className="col-lg-12 d-flex align-items-center justify-content-sm-between justify-content-center">
              <p>
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="menu-area">
                ...
                <div className="header-main-logo d-xl-block d-none">
                  <Link legacyBehavior href="/">
                    <a>
                      <img
                        alt="image"
                          ...
                          <ul>
                            <li>
                              ...
                              <div className="content">
                                <h6>
                                  <a href="#">
                                    Your application has accepted in 5
                                    vacancies.
                                  </a>
                                </h6>
                                <span>
