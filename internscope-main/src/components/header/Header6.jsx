          ...
          <div className="main-menu">
            ...
            <div className="for-mobile-menu d-lg-none d-block">
              <div className="sign-in-btn mb-25">
                <Link legacyBehavior href="/login">
                  <a className="primry-btn-6 lg-btn">
                    <svg
                      width={15}
                      height={15}
                      viewBox="0 0 15 15"
              ...
              <div className="post-job-btn mb-30">
                <Link legacyBehavior href="#">
                  <a className="primry-btn-5 lg-btn">
                    <svg
                      width={15}
                      height={13}
                      viewBox="0 0 15 13"
            ...
            <ul>
              <li>
                <div className="btn-group dropdown">
                  ...
                  <div
                    className="notifacion-card style-black dropdown-menu"
                    ...
                    <ul>
                      <li>
                        ...
                        <div className="content">
                          ...
                          <span>
                            <img src="assets/images/icon/clock-6.svg" alt="" />{" "}
                            10 min ago
                          </span>
                        </div>
                      </li>
