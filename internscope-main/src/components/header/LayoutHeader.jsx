            ...
            <ul className="menu-list">
              ...
              <li
                className={
                  ...
                  currentRoute === "/job-post" ||
                  currentRoute === "/faq" ||
                  currentRoute === "/candidates-dashboard/view-resume" ||
                  currentRoute === "/candidates-dashboard/settings" ||
                  currentRoute === "/candidates-dashboard/edit-profile" ||
                  currentRoute === "/candidates-dashboard/bookmark" ||
                  currentRoute === "/candidates-dashboard/my-profile" ||
                  currentRoute === "/candidates-dashboard/applied-job" ||
                  currentRoute === "/register" ||
                  currentRoute === "/pricing-plan"
                    ? "menu-item-has-children active"
                    : ""
                }
              >
              ...
              <li
                className={
                  currentRoute === "/company-listing1" ||
                  currentRoute === "/company-details" ||
                  currentRoute === "/company/company-dashboard" ||
                  currentRoute === "/company/company-profile" ||
                  currentRoute === "/company/company-job-list" ||
                  currentRoute === "/company/plans-billing" ||
                  currentRoute === "/company/company-setting" ||
                  currentRoute === "/company/company-dashboard"
                    ? "menu-item-has-children active"
                    : ""
                }
                ...
                >
                  ...
                  <li>
                    <Link legacyBehavior href="/company-details">
                      <a
                        className={
                          currentRoute === "/company-details" ? "active" : ""
                        }
                      >
                        Company Details
                      </a>
