...
function Home2TopRecruiters() {
  const slickSide = useMemo(() => {
    return {
      rows: 2,
      dots: false,
      arrows: true,
  ...
  return (
    <div className="home2-recruiters-area mb-120">
        ...
        <div className="row mb-60">
          <div className="col-12 d-flex flex-wrap align-items-end justify-content-md-between justify-content-start gap-3">
            <div className="section-title1">
              <h2>
                Top Level <span>Recruiters</span>
              </h2>
              <p>
...
export default Home2TopRecruiters;
