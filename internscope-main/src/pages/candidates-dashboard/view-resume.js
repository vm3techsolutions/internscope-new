        ...
        <div className="resume-area">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <a href="#">
                      info@example.com{" "}
                      <span>
                        <img src="/assets/images/icon/envlop-5.svg" alt="" />
                      </span>
                    </a>
                  </li>
                  <li>
          ...
          <div className="col-lg-12">
            <div className="single-information-area">
              ...
              <div className="description">
                <p>
                  I'm a passionate UI/UX designer and can bring innovative ideas
                  &amp; concepts to life for client-based design projects. I
                  have more than 3 years of design experience in
                  digital/e-commerce. I experienced at tackle various needs from
                  landing page designs, web app interfaces. I have skills in
                  User Experience Design (UXD), user-centered Design,
                  Interaction and Visual Design for websites, applications, web,
                  and mobile products, wireframes, mock-ups, qualitative and
                  quantitative user studies, usability analysis, and informal
                  usability audits.
                </p>
              </div>
            </div>
                ...
                <div className="col-lg-6 devaider1 position-relative">
                  <div className="informations">
                    <ul>
                      ...
                      <li>
                        <span>Date of Birth:</span> 03 January,1998
                      </li>
                      <li>
                ...
                <div className="col-lg-6 pl-40">
                  <div className="informations d-flex justify-content-end">
                    <ul>
                      ...
                      <li>
                        <span>National ID:</span> 88 9919 6712 8762
                      </li>
                      <li>
            ...
            <div className="single-information-area">
              ...
              <div className="educational-qualification mb-30">
                ...
                <div className="education-dt">
                  ...
                  <ul>
                    <li>
                      <span>Education Level:</span> Graduation
                    </li>
                    <li>
                      <span>My Major:</span> Bachelor Degree In CSE
                    </li>
                    <li>
                      <span>Result/GPA:</span> 3.75/4.00
                    </li>
                  </ul>
                </div>
              </div>
              <div className="educational-qualification">
                <div className="passing-year">
                  <p>
                    <span>02.</span>June, 2014- April, 2016
                  </p>
                  <span />
                </div>
                <div className="education-dt">
                  ...
                  <ul>
                    <li>
                      <span>Education Level:</span> HSC
                    </li>
                    <li>
                      <span>My Major:</span> Science
                    </li>
                    <li>
                      <span>Result/GPA:</span> 4.96/5.00
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="row g-4 ">
                <div className="col-lg-6 devaider1 position-relative">
                  <div className="informations">
                    <ul>
                      <li>
                        <span>Current Job Place:</span> Norland Tech of Industry
                      </li>
                      <li>
                        <span>Position:</span> UI/UX Engineer
                      </li>
                      <li>
                        <span>Experiences:</span> 3 Years
                      </li>
                    </ul>
                  </div>
                </div>
                <div className="col-lg-6 pl-40">
                  <div className="informations">
                    <ul>
                      <li>
                        <span>Current Salary:</span> 30000/=
                      </li>
                      <li>
                        <span>Expected Salary:</span> 40000/=
                      </li>
                      <li>
                        <span>Available:</span> Full Time
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <div className="col-lg-12">
            <div className="single-information-area">
              ...
              <div className="educational-qualification mb-30">
                <div className="passing-year">
                  <p>
                    <span>01.</span>April, 2021- May, 2022
                  </p>
                  <span />
                </div>
                <div className="education-dt">
                  ...
                  <p className="position">
                    <span>Position:</span> UI/UX Engineer ( Full-Time)
                  </p>
                  <div className="responsibility">
                    <h6>Responsibility:</h6>
                    <ul>
                      <li>
                        Creating high quality landing pages optimized for client
                        website brands.
                      </li>
                      <li>
                        Creating e-commerce interfaces, design enhancements, and
                        overall improved user experience of existing sites
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="educational-qualification">
                <div className="passing-year">
                  <p>
                    <span>02.</span>April, 2022- Continuing
                  </p>
                  <span />
                </div>
                <div className="education-dt">
          ...
          <div className="col-lg-12">
            <div className="declaration-area">
              ...
              <p>
                I do hereby declare that the information given above is true of
                my knowledge.
              </p>
            </div>
